...
fmuFilename = 'ControlledClocksSE.fmu'
...
for (commPointTime, commPointTarget, commPointEvent) in commPoints:
    ...
    # the argument activationTime is overloaded to communicate the start time of code execution instead
    fmu.activateModelPartition(vr[fmuClocks[commPointTarget][commPointEvent]], 0, commPointTime/(10**9))
